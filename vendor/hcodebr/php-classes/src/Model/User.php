	...
	public static function getForgot($email, $inadmin = true)
{
     ...
     if (count($results) === 0)
     {
         throw new \Exception("Não foi possível recuperar a senha. Código do erro 23.");
     }
     else
     {
         $data = $results[0];
         ...
         else
         {
             ...
             if ($inadmin === true) {
                 $link = "http://www.mapedine.com.br/admin/forgot/reset?code=$result";
             } else {
                 $link = "http://www.mapedine.com.br/forgot/reset?code=$result";
             } 
             $mailer = new Mailer($data['desemail'], $data['desperson'], "Redefinir senha da Mapedine Store", "forgot", array(
                 "name"=>$data['desperson'],
                 "link"=>$link
             )); 
             $mailer->send();
